@STATIC;1.0;I;23;Foundation/Foundation.ji;15;Configuration.ji;10;Generate.jt;4112;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("Configuration.j", YES);objj_executeFile("Generate.j", YES);main = function(args)
{
    args.shift();
    if (args.length < 1)
        return printUsage();
