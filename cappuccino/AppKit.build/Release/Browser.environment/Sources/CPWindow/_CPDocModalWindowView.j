@STATIC;1.0;i;15;_CPWindowView.jt;2017;
...
}),new objj_method(sel_getUid("_enableSheet:"),function(_11,_12,_13){
with(_11){
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("bodyBackgroundColor"),function(_14,_15){
with(_14){
if(!_1){
