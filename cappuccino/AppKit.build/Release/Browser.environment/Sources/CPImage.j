@STATIC;1.0;I;21;Foundation/CPBundle.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.jI;21;Foundation/CPString.jI;19;Foundation/CPData.ji;12;CGGeometry.ji;17;CPCompatibility.jt;19609;objj_executeFile("Foundation/CPBundle.j", NO);objj_executeFile("Foundation/CPNotificationCenter.j", NO);objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("Foundation/CPRunLoop.j", NO);objj_executeFile("Foundation/CPString.j", NO);objj_executeFile("Foundation/CPData.j", NO);objj_executeFile("CGGeometry.j", YES);objj_executeFile("CPCompatibility.j", YES);{var the_protocol = objj_allocateProtocol("CPImageDelegate");
...
{
    var dataURL;
    if (((___r1 = self._filename), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "hasPrefix:", "data:image")))
    ...
    return CPData.isa.objj_msgSend1(CPData, "dataWithBase64:", base64);
    var ___r1;
}
...
,["unsigned"]), new objj_method(sel_getUid("load"), function $CPImage__load(self, _cmd)
{
    ...
    self._image.onload = function()
    {
        if (isSynchronous)
            ...
            {
                self.isa.objj_msgSend0(self, "_imageDidLoad");
            }, 0);
        else
        {
            self.isa.objj_msgSend0(self, "_imageDidLoad");
        ...
        self.isa.objj_msgSend0(self, "_derefFromImage");
        var ___r1;
    };
    self._image.onerror = function()
    {
        if (isSynchronous)
            window.setTimeout(function()
            {
                self.isa.objj_msgSend0(self, "_imageDidError");
            }, 0);
        else
        {
            self.isa.objj_msgSend0(self, "_imageDidError");
    ...
    self._image.onabort = function()
    {
        if (isSynchronous)
            window.setTimeout(function()
            {
                self.isa.objj_msgSend0(self, "_imageDidAbort");
            }, 0);
        else
        {
            self.isa.objj_msgSend0(self, "_imageDidAbort");
