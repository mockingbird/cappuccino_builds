@STATIC;1.0;I;21;Foundation/CPObject.ji;8;CPView.jt;16857;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("CPView.j", YES);{var the_class = objj_allocateClassPair(CPObject, "CPColorPicker"),
...
class_addMethods(the_class, [new objj_method(sel_getUid("initWithFrame:"), function $__CPColorWheel__initWithFrame_(self, _cmd, aFrame)
{
    ...
    {
        var path = ((___r1 = CPBundle.isa.objj_msgSend1(CPBundle, "bundleForClass:", CPColorPicker)), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "pathForResource:", "wheel.png"));
        self._wheelImage = new Image();
        self._wheelImage.src = path;
        self._wheelImage.style.position = "absolute";
        path = ((___r1 = CPBundle.isa.objj_msgSend1(CPBundle, "bundleForClass:", CPColorPicker)), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "pathForResource:", "wheel_black.png"));
