@STATIC;1.0;i;15;CPApplication.ji;10;CPButton.ji;10;CPCookie.ji;9;CPPanel.ji;8;CPView.ji;15;CPColorPicker.ji;21;CPSliderColorPicker.jt;16777;
...
var _3e=objj_msgSend(objj_msgSend(CPTextField,"alloc"),"initWithFrame:",CGRectMake(10,_2+10,60,15));
...
var _40=objj_msgSend(objj_msgSend(CPTextField,"alloc"),"initWithFrame:",CGRectMake(10,_2+8+_1+6,60,15));
...
var _41=objj_msgSend(objj_msgSend(CPTextField,"alloc"),"initWithFrame:",CGRectMake(10,_2+_1+35,60,20));
...
var _78=CGRectMakeCopy(objj_msgSend(_77,"bounds"));
...
objj_msgSend(_73,"dragView:at:offset:event:pasteboard:source:slideBack:",_79,CGPointMake(_76.x-_78.size.width/2,_76.y-_78.size.height/2),CGPointMake(0,0),_75,nil,_73,YES);
}
