@STATIC;1.0;i;9;CPPanel.ji;16;_CPMenuManager.jt;22587;objj_executeFile("CPPanel.j", YES);objj_executeFile("_CPMenuManager.j", YES);{var the_class = objj_allocateClassPair(CPPanel, "_CPMenuBarWindow"),
...
{
    var bundleName = ((___r1 = CPBundle.isa.objj_msgSend0(CPBundle, "mainBundle")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "objectForInfoDictionaryKey:", "CPBundleName"));
    if (!(bundleName == null ? null : bundleName.isa.objj_msgSend0(bundleName, "length")))
        document.title = aTitle;
    else if ((aTitle == null ? null : aTitle.isa.objj_msgSend0(aTitle, "length")))
