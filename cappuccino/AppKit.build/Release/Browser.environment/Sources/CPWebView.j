@STATIC;1.0;i;8;CPView.ji;14;CPScrollView.jt;29818;objj_executeFile("CPView.j", YES);objj_executeFile("CPScrollView.j", YES);CPWebViewProgressStartedNotification = "CPWebViewProgressStartedNotification";
...
{
    if (self = (self == null ? null : self.isa.objj_msgSend1(self, "initWithFrame:", frameRect)))
    {
...
,["id","CGRect","CPString","CPString"]), new objj_method(sel_getUid("initWithFrame:"), function $CPWebView__initWithFrame_(self, _cmd, aFrame)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPWebView").super_class }, "initWithFrame:", aFrame))
    {
        ...
        (self == null ? null : self.isa.objj_msgSend1(self, "_initDOMWithFrame:", aFrame));
    }
    return self;
}
,["id","CGRect"]), new objj_method(sel_getUid("_initDOMWithFrame:"), function $CPWebView___initDOMWithFrame_(self, _cmd, aFrame)
{
    ...
    self.isa.objj_msgSend0(self, "_applyBackgroundColor");
    self._loadCallback = function()
    {
        if (!self._ignoreLoadStart)
        {
            self.isa.objj_msgSend0(self, "_startedLoading");
            if (self._mainFrameURL)
                ((___r1 = self._backwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", self._mainFrameURL));
            self._mainFrameURL = self._iframe.src;
            ((___r1 = self._forwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "removeAllObjects"));
        }
        else
            self._ignoreLoadStart = NO;
        if (!self._ignoreLoadEnd)
        {
            self.isa.objj_msgSend0(self, "_finishedLoading");
        }
        else
    ...
    self._frameView = ((___r1 = CPView.isa.objj_msgSend0(CPView, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "initWithFrame:", self.isa.objj_msgSend0(self, "bounds")));
    ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setAutoresizingMask:", CPViewWidthSizable | CPViewHeightSizable));
    self._scrollView = ((___r1 = CPScrollView.isa.objj_msgSend0(CPScrollView, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "initWithFrame:", self.isa.objj_msgSend0(self, "bounds")));
    ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setAutohidesScrollers:", YES));
    ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setAutoresizingMask:", CPViewWidthSizable | CPViewHeightSizable));
    ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setDocumentView:", self._frameView));
    self._frameView._DOMElement.appendChild(self._iframe);
    self.isa.objj_msgSend0(self, "_updateEffectiveScrollMode");
    self.isa.objj_msgSend1(self, "addSubview:", self._scrollView);
    var ___r1;
}
,["id","CGRect"]), new objj_method(sel_getUid("setFrameSize:"), function $CPWebView__setFrameSize_(self, _cmd, aSize)
{
    ...
    self.isa.objj_msgSend0(self, "_resizeWebFrame");
}
,["void","CGSize"]), new objj_method(sel_getUid("viewDidUnhide"), function $CPWebView__viewDidUnhide(self, _cmd)
{
    ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setFrameSize:", ((___r2 = self._scrollView), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "contentSize"))));
    self.isa.objj_msgSend0(self, "_resizeWebFrame");
    self.isa.objj_msgSend0(self, "_scheduleContentSizeCheck");
    var ___r1, ___r2;
}
,["void"]), new objj_method(sel_getUid("_attachScrollEventIfNecessary"), function $CPWebView___attachScrollEventIfNecessary(self, _cmd)
{
    if (self._effectiveScrollMode !== CPWebViewScrollAppKit)
        return;
    var win = self.isa.objj_msgSend0(self, "DOMWindow");
    if (win && win.addEventListener)
    {
        var scrollEventHandler = function(anEvent)
        {
            var frameBounds = self.isa.objj_msgSend0(self, "bounds"),
                frameCenter = CGPointMake(CGRectGetMidX(frameBounds), CGRectGetMidY(frameBounds)),
                windowOrigin = self.isa.objj_msgSend2(self, "convertPoint:toView:", frameCenter, nil),
                globalOrigin = ((___r1 = self.isa.objj_msgSend0(self, "window")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "convertBaseToBridge:", windowOrigin));
            anEvent._overrideLocation = globalOrigin;
            ((___r1 = ((___r2 = self.isa.objj_msgSend0(self, "window")), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "platformWindow"))), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "scrollEvent:", anEvent));
            var ___r1, ___r2;
        };
...
{
    if (!self.isa.objj_msgSend0(self, "_isVisible"))
    {
        return;
    }
    if (self._effectiveScrollMode === CPWebViewScrollAppKit)
    {
        var visibleRect = ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "visibleRect"));
        ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setFrameSize:", CGSizeMake(CGRectGetMaxX(visibleRect), CGRectGetMaxY(visibleRect))));
        var win = self.isa.objj_msgSend0(self, "DOMWindow");
        if (win && win.document && win.document.body)
        {
            ...
            ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setFrameSize:", CGSizeMake(width, height)));
        }
        else
        {
            if (!win || !win.document)
            {
                ...
                ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setFrameSize:", CGSizeMake(800, 1600)));
            }
        }
        ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "scrollRectToVisible:", visibleRect));
    }
    var ___r1;
}
...
,["int"]), new objj_method(sel_getUid("_updateEffectiveScrollMode"), function $CPWebView___updateEffectiveScrollMode(self, _cmd)
{
    ...
    if (_newScrollMode !== self._effectiveScrollMode)
        self.isa.objj_msgSend1(self, "_setEffectiveScrollMode:", _newScrollMode);
}
,["void"]), new objj_method(sel_getUid("_setEffectiveScrollMode:"), function $CPWebView___setEffectiveScrollMode_(self, _cmd, aScrollMode)
{
    ...
    if (self._effectiveScrollMode === CPWebViewScrollAppKit)
    {
        ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHasHorizontalScroller:", YES));
        ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHasVerticalScroller:", YES));
        self._iframe.setAttribute("scrolling", "no");
    }
    else if (self._effectiveScrollMode === CPWebViewScrollNone)
    {
        ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHasHorizontalScroller:", NO));
        ((___r1 = self._scrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setHasVerticalScroller:", NO));
        self._iframe.setAttribute("scrolling", "no");
    }
    else
    {
        ...
        ((___r1 = self._frameView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setFrameSize:", ((___r2 = self._scrollView), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "bounds")).size));
    }
...
,["void","int"]), new objj_method(sel_getUid("_maybePollWebFrameSize"), function $CPWebView___maybePollWebFrameSize(self, _cmd)
{
    if (CPWebViewAppKitScrollMaxPollCount == 0 || self._contentSizePollCount++ < CPWebViewAppKitScrollMaxPollCount)
        ...
        ((___r1 = self._contentSizeCheckTimer), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "invalidate"));
    var ___r1;
}
,["void"]), new objj_method(sel_getUid("loadHTMLString:"), function $CPWebView__loadHTMLString_(self, _cmd, aString)
{
    self.isa.objj_msgSend2(self, "loadHTMLString:baseURL:", aString, nil);
}
,["void","CPString"]), new objj_method(sel_getUid("loadHTMLString:baseURL:"), function $CPWebView__loadHTMLString_baseURL_(self, _cmd, aString, URL)
{
    ...
    self._url = nil;
    self._html = aString;
    self.isa.objj_msgSend0(self, "_load");
    var ___r1, ___r2;
}
...
,["void"]), new objj_method(sel_getUid("_load"), function $CPWebView___load(self, _cmd)
{
    if (self._url)
    {
        var cpurl = CPURL.isa.objj_msgSend1(CPURL, "URLWithString:", self._url);
        self._contentIsAccessible = (cpurl == null ? null : cpurl.isa.objj_msgSend0(cpurl, "_passesSameOriginPolicy"));
        self.isa.objj_msgSend0(self, "_updateEffectiveScrollMode");
        self._ignoreLoadEnd = NO;
...
{
    self._isLoading = YES;
    ((___r1 = CPNotificationCenter.isa.objj_msgSend0(CPNotificationCenter, "defaultCenter")), ___r1 == null ? null : ___r1.isa.objj_msgSend2(___r1, "postNotificationName:object:", CPWebViewProgressStartedNotification, self));
    if (((___r1 = self._frameLoadDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("webView:didStartProvisionalLoadForFrame:"))))
        ((___r1 = self._frameLoadDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend2(___r1, "webView:didStartProvisionalLoadForFrame:", self, nil));
    var ___r1;
}
,["void"]), new objj_method(sel_getUid("_finishedLoading"), function $CPWebView___finishedLoading(self, _cmd)
{
    self._isLoading = NO;
    self.isa.objj_msgSend0(self, "_resizeWebFrame");
    self.isa.objj_msgSend0(self, "_attachScrollEventIfNecessary");
    self.isa.objj_msgSend0(self, "_scheduleContentSizeCheck");
    ((___r1 = CPNotificationCenter.isa.objj_msgSend0(CPNotificationCenter, "defaultCenter")), ___r1 == null ? null : ___r1.isa.objj_msgSend2(___r1, "postNotificationName:object:", CPWebViewProgressFinishedNotification, self));
    if (((___r1 = self._frameLoadDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("webView:didFinishLoadForFrame:"))))
        ((___r1 = self._frameLoadDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend2(___r1, "webView:didFinishLoadForFrame:", self, nil));
    var ___r1;
}
,["void"]), new objj_method(sel_getUid("_scheduleContentSizeCheck"), function $CPWebView___scheduleContentSizeCheck(self, _cmd)
{
    ...
    if (self._effectiveScrollMode == CPWebViewScrollAppKit)
    {
        ...
        self._contentSizeCheckTimer = CPTimer.isa.objj_msgSend(CPTimer, "scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:", CPWebViewAppKitScrollPollInterval, self, sel_getUid("_maybePollWebFrameSize"), nil, YES);
    }
    var ___r1;
}
...
,["CPString"]), new objj_method(sel_getUid("setMainFrameURL:"), function $CPWebView__setMainFrameURL_(self, _cmd, URLString)
{
    ...
    ((___r1 = self._forwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "removeAllObjects"));
    self.isa.objj_msgSend0(self, "_loadMainFrameURL");
    var ___r1;
}
,["void","CPString"]), new objj_method(sel_getUid("goBack"), function $CPWebView__goBack(self, _cmd)
{
    ...
    {
        if (self._mainFrameURL)
            ((___r1 = self._forwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", self._mainFrameURL));
        self._mainFrameURL = ((___r1 = self._backwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "lastObject"));
        ((___r1 = self._backwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "removeLastObject"));
        self.isa.objj_msgSend0(self, "_loadMainFrameURL");
        return YES;
    }
    return NO;
...
,["BOOL"]), new objj_method(sel_getUid("goForward"), function $CPWebView__goForward(self, _cmd)
{
    if (self._forwardStack.length > 0)
    {
        if (self._mainFrameURL)
            ((___r1 = self._backwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "addObject:", self._mainFrameURL));
        self._mainFrameURL = ((___r1 = self._forwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "lastObject"));
        ((___r1 = self._forwardStack), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "removeLastObject"));
        self.isa.objj_msgSend0(self, "_loadMainFrameURL");
        return YES;
    }
    return NO;
...
{
    var win = self.isa.objj_msgSend0(self, "DOMWindow");
    if (!self._wso || win != ((___r1 = self._wso), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "window")))
    {
        if (win)
            self._wso = ((___r1 = (CPWebScriptObject == null ? null : CPWebScriptObject.isa.objj_msgSend0(CPWebScriptObject, "alloc"))), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "initWithWindow:", win));
        else
            self._wso = nil;
    }
    return self._wso;
...
{
    var result = self.isa.objj_msgSend1(self, "objectByEvaluatingJavaScriptFromString:", script);
...
{
    return ((___r1 = self.isa.objj_msgSend0(self, "windowScriptObject")), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "evaluateWebScript:", script));
    var ___r1;
}
...
{
    var win = ((___r1 = self.isa.objj_msgSend0(self, "windowScriptObject")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "window"));
    if (win)
    {
...
,["void","CPColor"]), new objj_method(sel_getUid("_applyBackgroundColor"), function $CPWebView___applyBackgroundColor(self, _cmd)
{
    if (self._iframe)
    {
        var bgColor = self.isa.objj_msgSend0(self, "backgroundColor") || CPColor.isa.objj_msgSend0(CPColor, "whiteColor");
        self._iframe.allowtransparency = !self._drawsBackground;
        self._iframe.style.backgroundColor = self._drawsBackground ? (bgColor == null ? null : bgColor.isa.objj_msgSend0(bgColor, "cssString")) : "transparent";
    }
}
,["void"]), new objj_method(sel_getUid("takeStringURLFrom:"), function $CPWebView__takeStringURLFrom_(self, _cmd, sender)
{
    self.isa.objj_msgSend1(self, "setMainFrameURL:", (sender == null ? null : sender.isa.objj_msgSend0(sender, "stringValue")));
}
,["void","id"]), new objj_method(sel_getUid("goBack:"), function $CPWebView__goBack_(self, _cmd, sender)
{
    self.isa.objj_msgSend0(self, "goBack");
}
,["void","id"]), new objj_method(sel_getUid("goForward:"), function $CPWebView__goForward_(self, _cmd, sender)
{
    self.isa.objj_msgSend0(self, "goForward");
}
...
,["void","id"]), new objj_method(sel_getUid("reload:"), function $CPWebView__reload_(self, _cmd, sender)
{
    if (!self._url && self._html !== nil)
        self.isa.objj_msgSend1(self, "loadHTMLString:", self._html);
    else
        self.isa.objj_msgSend0(self, "_loadMainFrameURL");
}
...
{
    try    {
        self.isa.objj_msgSend0(self, "DOMWindow").print();
    }
    catch(e)     {
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("initWithCoder:"), function $CPWebView__initWithCoder_(self, _cmd, aCoder)
{
    ...
    if (self)
    {
        ...
        self._forwardStack = [];
        self._scrollMode = CPWebViewScrollAuto;
        (self == null ? null : self.isa.objj_msgSend1(self, "_initDOMWithFrame:", (self == null ? null : self.isa.objj_msgSend0(self, "frame"))));
        if (!(self == null ? null : self.isa.objj_msgSend0(self, "backgroundColor")))
            (self == null ? null : self.isa.objj_msgSend1(self, "setBackgroundColor:", CPColor.isa.objj_msgSend0(CPColor, "whiteColor")));
        (self == null ? null : self.isa.objj_msgSend0(self, "_updateEffectiveScrollMode"));
    }
    return self;
}
...
{
    var documentURL = CPURL.isa.objj_msgSend1(CPURL, "URLWithString:", window.location.href);
    if ((documentURL == null ? null : documentURL.isa.objj_msgSend0(documentURL, "isFileURL")) && CPFeatureIsCompatible(CPSOPDisabledFromFileURLs))
        return YES;
    if (!self.isa.objj_msgSend0(self, "scheme") && !self.isa.objj_msgSend0(self, "host") && !self.isa.objj_msgSend0(self, "port"))
        return YES;
    return (documentURL == null ? null : documentURL.isa.objj_msgSend0(documentURL, "scheme")) == self.isa.objj_msgSend0(self, "scheme") && (documentURL == null ? null : documentURL.isa.objj_msgSend0(documentURL, "host")) == self.isa.objj_msgSend0(self, "host") && (documentURL == null ? null : documentURL.isa.objj_msgSend0(documentURL, "port")) == self.isa.objj_msgSend0(self, "port");
}
,["BOOL"])]);
}