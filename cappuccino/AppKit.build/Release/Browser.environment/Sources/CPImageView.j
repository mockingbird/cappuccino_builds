@STATIC;1.0;I;33;Foundation/CPNotificationCenter.ji;11;CPControl.ji;9;CPImage.ji;14;CPShadowView.jt;20901;objj_executeFile("Foundation/CPNotificationCenter.j", NO);objj_executeFile("CPControl.j", YES);objj_executeFile("CPImage.j", YES);objj_executeFile("CPShadowView.j", YES);CPImageAlignCenter = 0;
CPImageAlignTop = 1;
...
class_addMethods(the_class, [new objj_method(sel_getUid("initWithFrame:"), function $CPImageView__initWithFrame_(self, _cmd, aFrame)
{
    ...
    if (self)
    {
        (self == null ? null : self.isa.objj_msgSend0(self, "_createDOMImageElement"));
    }
    return self;
}
...
,["void","CPImage"]), new objj_method(sel_getUid("setObjectValue:"), function $CPImageView__setObjectValue_(self, _cmd, anImage)
{
    ...
    if (!self._DOMImageElement)
        self.isa.objj_msgSend0(self, "_createDOMImageElement");
    self._DOMImageElement.src = newImage ? (newImage == null ? null : newImage.isa.objj_msgSend0(newImage, "filename")) : (CPImageViewEmptyPlaceholderImage == null ? null : CPImageViewEmptyPlaceholderImage.isa.objj_msgSend0(CPImageViewEmptyPlaceholderImage, "filename"));
...
,["unsigned"]), new objj_method(sel_getUid("setImageScaling:"), function $CPImageView__setImageScaling_(self, _cmd, anImageScaling)
{
    ...
    if (self.isa.objj_msgSend1(self, "currentValueForThemeAttribute:", "image-scaling") === CPImageScaleAxesIndependently)
    {
        if (NULL)
