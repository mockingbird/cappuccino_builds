@STATIC;1.0;I;21;Foundation/CPObject.jI;18;Foundation/CPSet.ji;10;CPButton.jt;19899;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("Foundation/CPSet.j", NO);objj_executeFile("CPButton.j", YES);CPRadioImageOffset = 4.0;
...
,["void","CPString"]), new objj_method(sel_getUid("_setSelectedRadio:"), function $CPRadioGroup___setSelectedRadio_(self, _cmd, aRadio)
{
    ...
    (_CPRadioGroupSelectionBinder == null ? null : _CPRadioGroupSelectionBinder.isa.objj_msgSend1(_CPRadioGroupSelectionBinder, "reverseSetValueForObject:", self));
    var ___r1;
}
,["void","CPRadio"])]);
