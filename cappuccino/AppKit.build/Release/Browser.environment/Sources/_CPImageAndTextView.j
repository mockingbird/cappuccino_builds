@STATIC;1.0;I;21;Foundation/CPString.ji;9;CPColor.ji;8;CPFont.ji;9;CPImage.ji;8;CPView.ji;11;CPControl.jt;14674;
...
var _62=_DOMTextShadowElement.style,_63=(_font||objj_msgSend(CPFont,"systemFontOfSize:",CPFontCurrentSystemSize));
_62.font=objj_msgSend(_63,"cssString");
...
_62.lineHeight=objj_msgSend(_63,"defaultLineHeightForFont")+"px";
_62.zIndex=150;
...
if(_flags&_8){
var _63=(_font||objj_msgSend(CPFont,"systemFontOfSize:",CPFontCurrentSystemSize)),_64=objj_msgSend(_63,"cssString");
_5f.font=_64;
_5f.lineHeight=objj_msgSend(_63,"defaultLineHeightForFont")+"px";
if(_62){
_62.font=_64;
_62.lineHeight=objj_msgSend(_63,"defaultLineHeightForFont")+"px";
}
...
var _65=_image!==nil&&_imagePosition!==CPNoImage,_66=!!_DOMImageElement;
if(_65!==_66){
if(_66){
...
var _67=_DOMImageElement.style;
_67.top="0px";
_67.left="0px";
_67.position="absolute";
_67.zIndex=100;
_DOMElement.appendChild(_DOMImageElement);
_66=YES;
}
}
var _68=objj_msgSend(_5b,"bounds").size,_69={origin:{x:0,y:0},size:{width:_68.width,height:_68.height}};
if(_66){
if(!_67){
var _67=_DOMImageElement.style;
}
...
var _6a=_68.width/2,_6b=_68.height/2,_6c=objj_msgSend(_image,"size"),_6d=_6c.width,_6e=_6c.height;
if(_imageScaling===CPImageScaleAxesIndependently){
_6d=_68.width;
_6e=_68.height;
}else{
if(_imageScaling===CPImageScaleProportionallyDown){
var _6f=MIN(MIN(_68.width,_6d)/_6d,MIN(_68.height,_6e)/_6e);
_6d*=_6f;
_6e*=_6f;
}
}
if(CPFeatureIsCompatible(CPOpacityRequiresFilterFeature)){
_67.filter="alpha(opacity="+_shouldDimImage?35:100+")";
}else{
_67.opacity=_shouldDimImage?0.35:1;
}
_DOMImageElement.width=_6d;
_DOMImageElement.height=_6e;
_67.width=MAX(_6d,0)+"px";
_67.height=MAX(_6e,0)+"px";
if(_imagePosition===CPImageBelow){
_67.left=FLOOR(_6a-_6d/2)+"px";
_67.top=FLOOR(_68.height-_6e)+"px";
_69.size.height=_68.height-_6e-_imageOffset;
}else{
if(_imagePosition===CPImageAbove){
_67.left=FLOOR(_6a-_6d/2)+"px";
_67.top=0+"px";
_69.origin.y+=_6e+_imageOffset;
_69.size.height=_68.height-_6e-_imageOffset;
}else{
if(_imagePosition===CPImageLeft){
_67.top=FLOOR(_6b-_6e/2)+"px";
_67.left="0px";
_69.origin.x=_6d+_imageOffset;
_69.size.width-=_6d+_imageOffset;
}else{
if(_imagePosition===CPImageRight){
_67.top=FLOOR(_6b-_6e/2)+"px";
_67.left=FLOOR(_68.width-_6d)+"px";
_69.size.width-=_6d+_imageOffset;
}else{
...
if(_5e){
var _70=(_69.origin.x),_71=(_69.origin.y),_72=(_69.size.width),_73=(_69.size.height);
...
_textSize=objj_msgSend(_text,"sizeWithFont:inWidth:",_font,_72);
}else{
...
_71=_71+(_73-_textSize.height+1)/2;
_73=_textSize.height;
}else{
_71=_71+_73-_textSize.height;
_73=_textSize.height;
}
}
_5f.top=ROUND(_71)+"px";
_5f.left=ROUND(_70)+"px";
_5f.width=MAX(CEIL(_72),0)+"px";
_5f.height=MAX(CEIL(_73),0)+"px";
_5f.verticalAlign="top";
if(_62){
if(_flags&_9){
_62.color=objj_msgSend(_textShadowColor,"cssString");
}
_62.top=ROUND(_71+_textShadowOffset.height)+"px";
_62.left=ROUND(_70+_textShadowOffset.width)+"px";
_62.width=MAX(CEIL(_72),0)+"px";
_62.height=MAX(CEIL(_73),0)+"px";
}
}
_flags=0;
}
}),new objj_method(sel_getUid("sizeToFit"),function(_74,_75){
with(_74){
var _76=CGSizeMakeZero();
if((_imagePosition!==CPNoImage)&&_image){
var _77=objj_msgSend(_image,"size");
_76.width+=_77.width;
...
_76.width=MAX(_76.width,_textSize.width);
_76.height=MAX(_76.height,_textSize.height);
}else{
if(_imagePosition===CPImageLeft||_imagePosition===CPImageRight){
_76.width+=_textSize.width+_imageOffset;
_76.height=MAX(_76.height,_textSize.height);
}else{
if(_imagePosition===CPImageAbove||_imagePosition===CPImageBelow){
_76.width=MAX(_76.width,_textSize.width);
_76.height+=_textSize.height+_imageOffset;
}
}
}
}
objj_msgSend(_74,"setFrameSize:",_76);
}
})]);
