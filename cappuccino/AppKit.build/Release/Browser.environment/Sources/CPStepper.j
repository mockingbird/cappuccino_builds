@STATIC;1.0;i;11;CPControl.ji;10;CPButton.ji;13;CPTextField.jt;14245;objj_executeFile("CPControl.j", YES);objj_executeFile("CPButton.j", YES);objj_executeFile("CPTextField.j", YES);{var the_class = objj_allocateClassPair(CPControl, "CPStepper"),
...
,["void","CGRect"]), new objj_method(sel_getUid("layoutSubviews"), function $CPStepper__layoutSubviews(self, _cmd)
{
    ...
    objj_msgSend(self._buttonUp, "setValue:forThemeAttribute:inState:", objj_msgSend(self, "valueForThemeAttribute:inState:", "bezel-color-up-button", CPThemeState(CPThemeStateBordered, CPThemeStateDisabled)), "bezel-color", CPThemeState(CPThemeStateBordered, CPThemeStateDisabled));
    objj_msgSend(self._buttonUp, "setValue:forThemeAttribute:inState:", objj_msgSend(self, "valueForThemeAttribute:inState:", "bezel-color-up-button", CPThemeState(CPThemeStateBordered, CPThemeStateHighlighted)), "bezel-color", CPThemeState(CPThemeStateBordered, CPThemeStateHighlighted));
    ...
    objj_msgSend(self._buttonDown, "setValue:forThemeAttribute:inState:", objj_msgSend(self, "valueForThemeAttribute:inState:", "bezel-color-down-button", CPThemeState(CPThemeStateBordered, CPThemeStateDisabled)), "bezel-color", CPThemeState(CPThemeStateBordered, CPThemeStateDisabled));
    objj_msgSend(self._buttonDown, "setValue:forThemeAttribute:inState:", objj_msgSend(self, "valueForThemeAttribute:inState:", "bezel-color-down-button", CPThemeState(CPThemeStateBordered, CPThemeStateHighlighted)), "bezel-color", CPThemeState(CPThemeStateBordered, CPThemeStateHighlighted));
}
