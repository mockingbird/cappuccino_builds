...
,["void"]), new objj_method(sel_getUid("setDelegate:"), function $CPTokenField__setDelegate_(self, _cmd, aDelegate)
{
    ...
    self._implementedTokenFieldDelegateMethods = 0;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:hasMenuForRepresentedObject:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_hasMenuForRepresentedObject_;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:completionsForSubstring:indexOfToken:indexOfSelectedItem:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_completionsForSubstring_indexOfToken_indexOfSelectedItem_;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:shouldAddObjects:atIndex:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_shouldAddObjects_atIndex_;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:menuForRepresentedObject:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_menuForRepresentedObject_;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:displayStringForRepresentedObject:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_displayStringForRepresentedObject_;
    if (((___r1 = self._tokenFieldDelegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "respondsToSelector:", sel_getUid("tokenField:representedObjectForEditingString:"))))
        self._implementedTokenFieldDelegateMethods |= CPTokenFieldDelegate_tokenField_representedObjectForEditingString_;
...
,["void"]), new objj_method(sel_getUid("becomeFirstResponder"), function $CPTokenField__becomeFirstResponder(self, _cmd)
{
    if (!objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPTokenField").super_class }, "becomeFirstResponder"))
        return NO;
    if (CPTokenFieldInputOwner && (CPTokenFieldInputOwner == null ? null : CPTokenFieldInputOwner.isa.objj_msgSend0(CPTokenFieldInputOwner, "window")) !== self.isa.objj_msgSend0(self, "window"))
        ((___r1 = (CPTokenFieldInputOwner == null ? null : CPTokenFieldInputOwner.isa.objj_msgSend0(CPTokenFieldInputOwner, "window"))), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "makeFirstResponder:", nil));
...
,["BOOL"]), new objj_method(sel_getUid("_becomeFirstKeyResponder"), function $CPTokenField___becomeFirstKeyResponder(self, _cmd)
{
    ...
    self.isa.objj_msgSend0(self, "setNeedsLayout");
    var string = self.isa.objj_msgSend0(self, "stringValue"),
        element = self.isa.objj_msgSend0(self, "_inputElement"),
        font = self.isa.objj_msgSend1(self, "currentValueForThemeAttribute:", "font");
    element.value = nil;
    element.style.color = ((___r1 = self.isa.objj_msgSend1(self, "currentValueForThemeAttribute:", "text-color")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "cssString"));
...
default:
    ...
    var contentRect = self.isa.objj_msgSend1(self, "contentRectForBounds:", self.isa.objj_msgSend0(self, "bounds"));
    ...
    element.style.height = (font == null ? null : font.isa.objj_msgSend0(font, "defaultLineHeightForFont")) + "px";
    window.setTimeout(function()
    {
        ((___r1 = self._tokenScrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "documentView"))._DOMElement.appendChild(element);
...
,["BOOL"]), new objj_method(sel_getUid("_resignFirstKeyResponder"), function $CPTokenField___resignFirstKeyResponder(self, _cmd)
{
    ...
    CPTokenFieldInputDidBlur = NO;
    CPTokenFieldInputResigning = NO;
    if (element.parentNode == ((___r1 = self._tokenScrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "documentView"))._DOMElement)
...
,["CPString"]), new objj_method(sel_getUid("objectValue"), function $CPTokenField__objectValue(self, _cmd)
{
    ...
    {
        var token = self.isa.objj_msgSend1(self, "_representedObjectForEditingString:", self.isa.objj_msgSend0(self, "_editorValue"));
        (objectValue == null ? null : objectValue.isa.objj_msgSend2(objectValue, "insertObject:atIndex:", token, self._selectedRange.location));
    }
    return objectValue;
    var ___r1;
}
...
,["BOOL","CPString"]), new objj_method(sel_getUid("_inputElement"), function $CPTokenField___inputElement(self, _cmd)
{
    if (!CPTokenFieldDOMInputElement)
    {
        ...
        {
            return CPTextFieldBlurFunction(anEvent, CPTokenFieldInputOwner, CPTokenFieldInputOwner ? ((___r1 = CPTokenFieldInputOwner._tokenScrollView), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "documentView"))._DOMElement : nil, CPTokenFieldDOMInputElement, CPTokenFieldInputResigning, function(__input) { if (arguments.length) return CPTokenFieldInputDidBlur = __input; return CPTokenFieldInputDidBlur; });
            var ___r1;
        };
    ...
    {
        if ((CPTokenFieldInputOwner == null ? null : CPTokenFieldInputOwner.isa.objj_msgSend0(CPTokenFieldInputOwner, "isSecure")))
...
{
    CPTokenFieldTextDidChangeValue = self.isa.objj_msgSend0(self, "stringValue");
...
{
    if (self.isa.objj_msgSend0(self, "stringValue") !== CPTokenFieldTextDidChangeValue)
    {
        self.isa.objj_msgSend1(self, "textDidChange:", CPNotification.isa.objj_msgSend3(CPNotification, "notificationWithName:object:userInfo:", CPControlTextDidChangeNotification, self, nil));
    }
    ((___r1 = ((___r2 = self.isa.objj_msgSend0(self, "window")), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "platformWindow"))), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "_propagateCurrentDOMEvent:", YES));
...
{
    if (!(self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_completionsForSubstring_indexOfToken_indexOfSelectedItem_))
        return [];
...
{
    if (self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_displayStringForRepresentedObject_)
    {
...
{
    if (self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_shouldAddObjects_atIndex_)
    {
...
{
    if (self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_representedObjectForEditingString_)
    {
...
{
    if (self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_hasMenuForRepresentedObject_ && self._implementedTokenFieldDelegateMethods & CPTokenFieldDelegate_tokenField_menuForRepresentedObject_)
