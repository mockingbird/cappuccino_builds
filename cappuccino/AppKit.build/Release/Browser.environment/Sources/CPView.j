...
,["void","CPView","CPWindowOrderingMode","CPView"]), new objj_method(sel_getUid("_insertSubview:atIndex:"), function $CPView___insertSubview_atIndex_(self, _cmd, aSubview, anIndex)
{
    ...
    else
    {
        ...
        lastWindow = (superview == null ? null : superview.isa.objj_msgSend0(superview, "window"));
        (aSubview == null ? null : aSubview.isa.objj_msgSend0(aSubview, "_removeFromSuperview"));
    ...
    if (!self._window && lastWindow)
        (aSubview == null ? null : aSubview.isa.objj_msgSend1(aSubview, "_setWindow:", nil));
    if (self._themeState)
    {
...
,["void","CPView"]), new objj_method(sel_getUid("removeFromSuperview"), function $CPView__removeFromSuperview(self, _cmd)
{
    ...
    self.isa.objj_msgSend1(self, "viewWillMoveToSuperview:", nil);
    self.isa.objj_msgSend0(self, "_removeFromSuperview");
    self.isa.objj_msgSend0(self, "viewDidMoveToSuperview");
    if (superview)
...
{
    ((___r1 = self.isa.objj_msgSend0(self, "window")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "_dirtyKeyViewLoop"));
    if (((___r1 = self._window), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "firstResponder")) === self && self._window != aWindow)
...
{
    self.isa.objj_msgSend0(self, "_removeObservers");
    if (aView)
        self.isa.objj_msgSend0(self, "_addObservers");
}
...
,["void","CPView"]), new objj_method(sel_getUid("_removeObservers"), function $CPView___removeObservers(self, _cmd)
{
    ...
    var count = ((___r1 = self._subviews), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "count"));
    while (count--)
        ((___r1 = self._subviews[count]), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "_removeObservers"));
...
,["void"]), new objj_method(sel_getUid("_addObservers"), function $CPView___addObservers(self, _cmd)
{
    ...
    var count = ((___r1 = self._subviews), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "count"));
    while (count--)
        ((___r1 = self._subviews[count]), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "_addObservers"));
...
,["void","CGPoint"]), new objj_method(sel_getUid("setFrameSize:"), function $CPView__setFrameSize_(self, _cmd, aSize)
{
    ...
    if (self._backgroundType !== BackgroundTrivialColor)
    {
        ...
        {
            var images = ((___r1 = ((___r2 = self._backgroundColor), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "patternImage"))), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "imageSlices")),
                partIndex = 0,
                frameSize = aSize;
...
{
    var scale = self.isa.objj_msgSend0(self, "scaleSize");
...
,["CPMenu","CPEvent"]), new objj_method(sel_getUid("setBackgroundColor:"), function $CPView__setBackgroundColor_(self, _cmd, aColor)
{
    ...
    var patternImage = ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "patternImage")),
        colorExists = self._backgroundColor && (((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "patternImage")) || ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "alphaComponent")) > 0.0),
        colorHasAlpha = colorExists && ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "alphaComponent")) < 1.0,
    ...
    {
        self._backgroundType = (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "isVertical")) ? BackgroundVerticalThreePartImage : BackgroundHorizontalThreePartImage;
        amount = 3;
    }
    else if ((patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "isNinePartImage")))
    {
    ...
    {
        slices = (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "imageSlices"));
        amount = MIN(amount, slices.length);
        for (var i = 0, count = slices.length; i < count; i++)
        {
            var image = slices[i],
                size = (image == null ? null : image.isa.objj_msgSend0(image, "size"));
    ...
    {
        var colorCSS = colorExists ? ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "cssString")) : "";
        if (colorNeedsDOMElement)
        {
            self._DOMElement.style.background = "";
            self._DOMImageParts[0].style.background = ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "cssString"));
            if (patternImage)
                self._DOMImageParts[0].style.backgroundSize = (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "size")).width + "px" + ' ' + (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "size")).height + "px";
            if (CPFeatureIsCompatible(CPOpacityRequiresFilterFeature))
                self._DOMImageParts[0].style.filter = "alpha(opacity=" + ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "alphaComponent")) * 100 + ")";
            else
                self._DOMImageParts[0].style.opacity = ((___r1 = self._backgroundColor), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "alphaComponent"));
        ...
        if (patternImage)
            self._DOMElement.style.backgroundSize = (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "size")).width + "px" + ' ' + (patternImage == null ? null : patternImage.isa.objj_msgSend0(patternImage, "size")).height + "px";
    }
    else
    {
        var frameSize = self._frame.size,
        ...
        for (var i = 0; i < slices.length; i++)
        {
            ...
            self._DOMImageParts[partIndex].style.width = MAX(0.0, ROUND(size.width)) + "px";
            self._DOMImageParts[partIndex].style.height = MAX(0.0, ROUND(size.height)) + "px";
            self._DOMImageParts[partIndex].style.background = "url(\"" + (image == null ? null : image.isa.objj_msgSend0(image, "filename")) + "\")";
            if (!supportsRGBA)
            {
                if (CPFeatureIsCompatible(CPOpacityRequiresFilterFeature))
                    try                    {
...
,["CGSize"]), new objj_method(sel_getUid("_applyCSSScalingTranformations"), function $CPView___applyCSSScalingTranformations(self, _cmd)
{
    if (self._isScaled)
    {
        ...
        self.isa.objj_msgSend1(self, "_setDisplayServerSetStyleSize:", self.isa.objj_msgSend0(self, "frameSize"));
    }
}
...
,["void","CGRect"]), new objj_method(sel_getUid("displayRectIgnoringOpacity:inContext:"), function $CPView__displayRectIgnoringOpacity_inContext_(self, _cmd, aRect, aGraphicsContext)
{
    if (self.isa.objj_msgSend0(self, "isHidden"))
        return;
    self.isa.objj_msgSend0(self, "lockFocus");
    CGContextClearRect(((___r1 = CPGraphicsContext.isa.objj_msgSend0(CPGraphicsContext, "currentContext")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "graphicsPort")), aRect);
    self.isa.objj_msgSend1(self, "drawRect:", aRect);
    self.isa.objj_msgSend0(self, "unlockFocus");
    var ___r1;
}
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("initWithCoder:"), function $CPView__initWithCoder_(self, _cmd, aCoder)
{
    ...
    if (self)
    {
        ...
        self._DOMElement.style.left = ROUND(____p.x) + "px";
        self._DOMElement.style.top = ROUND(____p.y) + "px";
        (self == null ? null : self.isa.objj_msgSend1(self, "_setDisplayServerSetStyleSize:", self._frame.size));
        var index = 0,
            count = self._subviews.length;
        for (; index < count; ++index)
        {
