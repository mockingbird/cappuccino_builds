@STATIC;1.0;I;21;Foundation/CPObject.ji;13;CPTextField.ji;13;CPTableView.ji;15;_CPMenuWindow.jt;12851;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("CPTextField.j", YES);objj_executeFile("CPTableView.j", YES);objj_executeFile("_CPMenuWindow.j", YES);var _CPAutocompleteMenuMaximumHeight = 307;
...
,["CPString"]), new objj_method(sel_getUid("layoutSubviews"), function $_CPAutocompleteMenu__layoutSubviews(self, _cmd)
{
    ...
    if (self.widestItemWidth === CPNotFound)
    {
        var dataView = objj_msgSend(tableColumn, "dataView"),
            ...
            fontSelected = objj_msgSend(dataView, "valueForThemeAttribute:inState:", "font", CPThemeState(CPThemeStateTableDataView, CPThemeStateSelectedDataView)),
            contentInsetNormal = objj_msgSend(dataView, "valueForThemeAttribute:inState:", "content-inset", CPThemeStateTableDataView),
            contentInsetSelected = objj_msgSend(dataView, "valueForThemeAttribute:inState:", "content-inset", CPThemeState(CPThemeStateTableDataView, CPThemeStateSelectedDataView));
