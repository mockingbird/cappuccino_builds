@STATIC;1.0;I;21;Foundation/CPObject.jt;4016;
objj_executeFile("Foundation/CPObject.j",NO);
var _1=NULL;
var _2=objj_allocateClassPair(CPObject,"CPPlatformWindow"),_3=_2.isa;
class_addIvars(_2,[new objj_ivar("_contentRect"),new objj_ivar("_level"),new objj_ivar("_hasShadow"),new objj_ivar("_shadowStyle"),new objj_ivar("_title")]);
...
}),new objj_method(sel_getUid("_setTitle:window:"),function(_39,_3a,_3b,_3c){
with(_39){
_title=_3b;
}
}),new objj_method(sel_getUid("title"),function(_3d,_3e){
with(_3d){
return _title;
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("visiblePlatformWindows"),function(_3f,_40){
with(_3f){
return objj_msgSend(CPSet,"set");
}
}),new objj_method(sel_getUid("supportsMultipleInstances"),function(_41,_42){
with(_41){
return NO;
}
}),new objj_method(sel_getUid("primaryPlatformWindow"),function(_43,_44){
with(_43){
return _1;
}
}),new objj_method(sel_getUid("setPrimaryPlatformWindow:"),function(_45,_46,_47){
with(_45){
_1=_47;
}
})]);
