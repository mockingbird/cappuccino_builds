@STATIC;1.0;I;21;Foundation/CPObject.ji;8;CPFont.jt;9779;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("CPFont.j", YES);CPItalicFontMask = 1 << 0;
CPBoldFontMask = 1 << 1;
...
,["id"]), new objj_method(sel_getUid("availableFonts"), function $CPFontManager__availableFonts(self, _cmd)
{
    if (!self._availableFonts)
    {
        ...
        self._availableFonts = _CPFontDetectAllFonts;
    }
...
{
    return (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isBold")) ? 9 : 5;
}
,["int","CPFont"]), new objj_method(sel_getUid("traitsOfFont:"), function $CPFontManager__traitsOfFont_(self, _cmd, aFont)
{
    return ((aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isBold")) ? CPBoldFontMask : 0) | ((aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isItalic")) ? CPItalicFontMask : 0);
}
,["CPFontTraitMask","CPFont"]), new objj_method(sel_getUid("convertFont:"), function $CPFontManager__convertFont_(self, _cmd, aFont)
{
    if (!self._activeChange)
        return aFont;
    var addTraits = ((___r1 = self._activeChange), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "valueForKey:", "addTraits"));
    if (addTraits)
        aFont = self.isa.objj_msgSend2(self, "convertFont:toHaveTrait:", aFont, addTraits);
    return aFont;
    var ___r1;
}
,["CPFont","CPFont"]), new objj_method(sel_getUid("convertFont:toHaveTrait:"), function $CPFontManager__convertFont_toHaveTrait_(self, _cmd, aFont, addTraits)
{
    if (!aFont)
        return nil;
    var shouldBeBold = ((aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isBold")) || addTraits & CPBoldFontMask) && !(addTraits & CPUnboldFontMask),
        shouldBeItalic = ((aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isItalic")) || addTraits & CPItalicFontMask) && !(addTraits & CPUnitalicFontMask),
        shouldBeSize = (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "size"));
    aFont = CPFont.isa.objj_msgSend(CPFont, "_fontWithName:size:bold:italic:", (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "familyName")), shouldBeSize, shouldBeBold, shouldBeItalic) || aFont;
    return aFont;
}
,["CPFont","CPFont","CPFontTraitMask"]), new objj_method(sel_getUid("convertFont:toFace:"), function $CPFontManager__convertFont_toFace_(self, _cmd, aFont, aTypeface)
{
    if (!aFont)
        return nil;
    var shouldBeBold = (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isBold")),
        shouldBeItalic = (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "isItalic")),
        shouldBeSize = (aFont == null ? null : aFont.isa.objj_msgSend0(aFont, "size"));
    aFont = CPFont.isa.objj_msgSend(CPFont, "_fontWithName:size:bold:italic:", aTypeface, shouldBeSize, shouldBeBold, shouldBeItalic) || aFont;
    return aFont;
}
,["CPFont","CPFont","CPString"]), new objj_method(sel_getUid("addFontTrait:"), function $CPFontManager__addFontTrait_(self, _cmd, sender)
{
    var tag = (sender == null ? null : sender.isa.objj_msgSend0(sender, "tag"));
    ...
    self.isa.objj_msgSend0(self, "sendAction");
}
,["void","id"]), new objj_method(sel_getUid("sendAction"), function $CPFontManager__sendAction(self, _cmd)
{
    return (CPApp == null ? null : CPApp.isa.objj_msgSend3(CPApp, "sendAction:to:from:", self._action, self._target, self));
}
,["BOOL"])]);
class_addMethods(meta_class, [new objj_method(sel_getUid("sharedFontManager"), function $CPFontManager__sharedFontManager(self, _cmd)
{
    if (!CPSharedFontManager)
        CPSharedFontManager = ((___r1 = (CPFontManagerFactory == null ? null : CPFontManagerFactory.isa.objj_msgSend0(CPFontManagerFactory, "alloc"))), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "init"));
...
CPFontManager.isa.objj_msgSend1(CPFontManager, "setFontManagerFactory:", CPFontManager.isa.objj_msgSend0(CPFontManager, "class"));
