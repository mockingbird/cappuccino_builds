@STATIC;1.0;I;21;Foundation/CPObject.ji;10;CPButton.ji;8;CPMenu.ji;9;CPPanel.jt;18340;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("CPButton.j", YES);objj_executeFile("CPMenu.j", YES);objj_executeFile("CPPanel.j", YES);CPClosableOnBlurWindowMask = 1 << 4;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_animates"), new objj_ivar("_targetView"), new objj_ivar("_appearance"), new objj_ivar("_isClosing"), new objj_ivar("_browserAnimates"), new objj_ivar("_closeOnBlur"), new objj_ivar("_isObservingFrame"), new objj_ivar("_shouldPerformAnimation"), new objj_ivar("_implementedDelegateMethods"), new objj_ivar("_orderOutTransitionFunction")]);objj_registerClassPair(the_class);
...
,["void","CPView"]), new objj_method(sel_getUid("positionRelativeToRect:ofView:preferredEdge:"), function $_CPPopoverWindow__positionRelativeToRect_ofView_preferredEdge_(self, _cmd, aRect, positioningView, anEdge)
{
    ...
    if (positioningView !== self._targetView)
    {
        ...
        objj_msgSend(self, "_removeFrameObserver");
...
,["BOOL"]), new objj_method(sel_getUid("updateFrameWithSize:"), function $_CPPopoverWindow__updateFrameWithSize_(self, _cmd, aSize)
{
    ...
    rect.size = aSize;
    rect.origin = objj_msgSend(objj_msgSend(self, "contentView"), "frameOrigin");
    objj_msgSend(self, "setFrame:", objj_msgSend(self, "frameRectForContentRect:", rect));
...
{
    if (!objj_msgSend(self, "isVisible"))
        objj_msgSend(self, "_addFrameObserver");
