@STATIC;1.0;i;15;_CPWindowView.jt;2959;
...
},["CGRect","CGRect"]), new objj_method(sel_getUid("_enableSheet:"), function $_CPDocModalWindowView___enableSheet_(self, _cmd, enable)
{ with(self)
{
