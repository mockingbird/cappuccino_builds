@STATIC;1.0;I;21;Foundation/CPObject.ji;8;CPView.jt;4449;
...
{ with(self)
{
    ...
    if (objj_msgSend(_tabView, "selectedTabViewItem") == self)
        objj_msgSend(_tabView, "_setContentViewForItem:", self);
}
