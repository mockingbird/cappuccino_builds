...
,["CPString"]), new objj_method(sel_getUid("_cibInstantiate"), function $_CPCibWindowTemplate___cibInstantiate(self, _cmd)
{
    ...
    if (!windowClass)
    {
        CPLog.warn("Unknown class \"%@\" in cib file, using CPWindow instead.", objj_msgSend(self, "windowClass"));
