...
{ with(self)
{
    return objj_msgSend(self, "instantiateCibWithExternalNameTable:", objj_msgSend(CPDictionary, "dictionaryWithObjects:forKeys:", [anOwner, topLevelObjects], [CPCibOwner, CPCibTopLevelObjects]));
}
},["BOOL","id","CPArray"])]);
}
