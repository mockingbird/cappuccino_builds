@STATIC;1.0;I;21;Foundation/CPObject.ji;10;CPButton.ji;9;CPColor.ji;9;CPImage.ji;13;CPImageView.ji;13;CPResponder.ji;8;CPView.ji;18;_CPPopoverWindow.jt;16444;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("CPButton.j", YES);objj_executeFile("CPColor.j", YES);objj_executeFile("CPImage.j", YES);objj_executeFile("CPImageView.j", YES);objj_executeFile("CPResponder.j", YES);objj_executeFile("CPView.j", YES);objj_executeFile("_CPPopoverWindow.j", YES);{var the_protocol = objj_allocateProtocol("CPPopoverDelegate");
...
,["void"]), new objj_method(sel_getUid("performClose:"), function $CPPopover__performClose_(self, _cmd, sender)
{
    if (((___r1 = self._popoverWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "isClosing")))
        return;
    if (!self.isa.objj_msgSend0(self, "_popoverShouldClose"))
        return;
    self.isa.objj_msgSend0(self, "_close");
    var ___r1;
}
...
,["void"]), new objj_method(sel_getUid("_popoverShouldClose"), function $CPPopover___popoverShouldClose(self, _cmd)
{
    if (self._implementedDelegateMethods & CPPopoverDelegate_popover_shouldClose_)
        return ((___r1 = self._delegate), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "popoverShouldClose:", self));
    return YES;
    var ___r1;
}
