@STATIC;1.0;i;27;../Foundation/CPFormatter.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.ji;19;CPKeyValueBinding.jt;30941;
...
{ with(self)
{
    return objj_msgSend(CPDictionary, "dictionaryWithObjects:forKeys:", [CPLeftTextAlignment,
                                                ...
                                                objj_msgSend(CPFont, "systemFontOfSize:", CPFontCurrentSystemSize),
...
{ with(self)
{
    ...
    if (_formatter !== nil)
        objj_msgSend(aCoder, "encodeObject:forKey:", _formatter, CPControlFormatterKey);
}
},["void","CPCoder"])]);
}
