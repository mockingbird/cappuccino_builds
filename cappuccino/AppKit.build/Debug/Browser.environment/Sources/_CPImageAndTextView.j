@STATIC;1.0;I;21;Foundation/CPString.ji;9;CPColor.ji;8;CPFont.ji;9;CPImage.ji;8;CPView.ji;11;CPControl.jt;26309;
...
{ with(self)
{
    ...
    if (objj_msgSend(_image, "delegate") === self)
        objj_msgSend(objj_msgSend(CPNotificationCenter, "defaultCenter"), "removeObserver:name:object:", self, CPImageDidLoadNotification, _image);

    _image = anImage;
    _flags |= _CPImageAndTextViewImageChangedFlag;

    if (objj_msgSend(_image, "loadStatus") !== CPImageLoadStatusCompleted)
        objj_msgSend(objj_msgSend(CPNotificationCenter, "defaultCenter"), "addObserver:selector:name:object:", self, sel_getUid("imageDidLoad:"), CPImageDidLoadNotification, _image);
...
{ with(self)
{
    ...
    var needsDOMTextShadowElement = hasDOMTextElement && objj_msgSend(_textShadowColor, "alphaComponent") > 0.0,
    ...
    if (needsDOMTextShadowElement !== hasDOMTextShadowElement)
    {
        ...
        else
        {
            ...
            var shadowStyle = _DOMTextShadowElement.style,
                font = (_font || objj_msgSend(CPFont, "systemFontOfSize:", CPFontCurrentSystemSize));
    ...
    if (hasDOMTextElement)
    {
        ...
        {
            var font = (_font || objj_msgSend(CPFont, "systemFontOfSize:", CPFontCurrentSystemSize)),
