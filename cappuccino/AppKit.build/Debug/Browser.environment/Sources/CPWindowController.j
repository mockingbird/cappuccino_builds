@STATIC;1.0;I;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;13;CPResponder.ji;10;CPWindow.ji;12;CPDocument.jt;15872;
...
{ with(self)
{
    ...
    objj_msgSend(objj_msgSend(CPBundle, "mainBundle"), "loadCibFile:externalNameTable:", objj_msgSend(self, "windowCibPath"), objj_msgSend(CPDictionary, "dictionaryWithObject:forKey:", _cibOwner, CPCibOwner));
}
...
{ with(self)
{
    ...
    objj_msgSend(objj_msgSend(objj_msgSend(self, "window"), "toolbar"), "validateVisibleItems");
}
...
{ with(self)
{
    ...
    if (containerView)
    {
        var oldView = objj_msgSend(_viewController, "isViewLoaded") ? objj_msgSend(_viewController, "view") : nil;
