@STATIC;1.0;i;11;CPControl.ji;10;CPButton.ji;13;CPTextField.jt;14124;objj_executeFile("CPControl.j", YES);objj_executeFile("CPButton.j", YES);objj_executeFile("CPTextField.j", YES);{var the_class = objj_allocateClassPair(CPControl, "CPStepper"),
