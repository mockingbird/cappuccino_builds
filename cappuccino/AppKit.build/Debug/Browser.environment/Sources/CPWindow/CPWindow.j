...
,["id"]), new objj_method(sel_getUid("initWithContentRect:styleMask:"), function $CPWindow__initWithContentRect_styleMask_(self, _cmd, aContentRect, aStyleMask)
{
    ...
    if (self)
    {
        ...
        if (!(self == null ? null : self.isa.objj_msgSend0(self, "_sharesChromeWithPlatformWindow")))
        {
            if (NULL)
...
{
    ((___r1 = self.isa.objj_msgSend0(self, "contentView")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "_addObservers"));
    if (self._isSheet)
        ((___r1 = self._parentView), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "orderFront:", self));
    if (!self._isVisible)
        self.isa.objj_msgSend(self, "_setFrame:display:animate:constrainWidth:constrainHeight:", self._frame, YES, NO, YES, YES);
    ((___r1 = self._platformWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "orderFront:", self));
    ((___r1 = self._platformWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend3(___r1, "order:window:relativeTo:", CPWindowAbove, self, nil));
    if (!CPApp._keyWindow)
...
,["void","id"]), new objj_method(sel_getUid("_orderOutRecursively:"), function $CPWindow___orderOutRecursively_(self, _cmd, recursive)
{
    if (!self._isVisible)
        return;
    ((___r1 = self.isa.objj_msgSend0(self, "contentView")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "_removeObservers"));
    ...
    if (self.isa.objj_msgSend0(self, "_sharesChromeWithPlatformWindow"))
        ((___r1 = self._platformWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "orderOut:", self));
    ((___r1 = self._platformWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend3(___r1, "order:window:relativeTo:", CPWindowOut, self, nil));
    self.isa.objj_msgSend1(self, "makeFirstResponder:", nil);
...
,["void","BOOL"]), new objj_method(sel_getUid("orderWindow:relativeTo:"), function $CPWindow__orderWindow_relativeTo_(self, _cmd, orderingMode, otherWindowNumber)
{
    if (orderingMode === CPWindowOut)
    {
        ...
        ((___r1 = self._platformWindow), ___r1 == null ? null : ___r1.isa.objj_msgSend3(___r1, "order:window:relativeTo:", orderingMode, self, CPApp._windows[otherWindowNumber]));
    var ___r1;
}
...
default:
    ...
    case CPKeyDown:
        if ((anEvent == null ? null : anEvent.isa.objj_msgSend0(anEvent, "charactersIgnoringModifiers")) === CPTabCharacter)
        {
            ...
            ((___r1 = ((___r2 = (anEvent == null ? null : anEvent.isa.objj_msgSend0(anEvent, "window"))), ___r2 == null ? null : ___r2.isa.objj_msgSend0(___r2, "platformWindow"))), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "_propagateCurrentDOMEvent:", NO));
            return;
        }
