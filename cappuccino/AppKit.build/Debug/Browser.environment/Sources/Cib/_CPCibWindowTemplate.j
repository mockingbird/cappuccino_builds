@STATIC;1.0;I;21;Foundation/CPObject.ji;12;CGGeometry.ji;10;CPWindow.jt;6762;
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _windowAutorecalculatesKeyViewLoop = objj_msgSend(aCoder, "decodeBoolForKey:", _CPCibWindowTemplateWindowAutorecalculatesKeyViewLoop);
        _windowIsFullPlatformWindow = objj_msgSend(aCoder, "decodeBoolForKey:", _CPCibWindowTemplateWindowIsFullPlatformWindowKey);
    }
...
{ with(self)
{
    var windowClass = CPClassFromString(objj_msgSend(self, "windowClass")),
        theWindow = objj_msgSend(objj_msgSend(windowClass, "alloc"), "initWithContentRect:styleMask:", _windowRect, _windowStyleMask);
