@STATIC;1.0;I;27;Foundation/CPCharacterSet.jI;23;Foundation/CPIndexSet.jI;20;Foundation/CPTimer.ji;10;CPButton.ji;14;CPScrollView.ji;13;CPTextField.ji;13;CPTableView.ji;10;CPWindow.ji;21;_CPAutocompleteMenu.jt;49228;
...
{ with(self)
{
    ...
    {
        var token = objj_msgSend(self, "_representedObjectForEditingString:", objj_msgSend(self, "_inputElement").value);
...
},["DOMElement"]), new objj_method(sel_getUid("moveUp:"), function $CPTokenField__moveUp_(self, _cmd, sender)
{ with(self)
{
