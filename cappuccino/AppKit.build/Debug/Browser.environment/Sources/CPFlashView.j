@STATIC;1.0;i;14;CPFlashMovie.ji;8;CPView.jt;6652;
...
{ with(self)
{
    ...
    while ((key = objj_msgSend(enumerator, "nextObject")) !== nil)
...
{ with(self)
{
    ...
    if (!_params)
        ...
        objj_msgSend(_params, "addEntriesFromDictionary:", aDictionary);
    ...
    if (!CPBrowserIsEngine(CPInternetExplorerBrowserEngine))
    {
        ...
        while (_DOMObjectElement && (key = objj_msgSend(enumerator, "nextObject")) !== nil)
        {
