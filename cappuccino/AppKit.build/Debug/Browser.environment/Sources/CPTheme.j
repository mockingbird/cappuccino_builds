@STATIC;1.0;I;21;Foundation/CPObject.jI;27;Foundation/CPMutableArray.jI;21;Foundation/CPString.jI;30;Foundation/CPKeyedUnarchiver.jt;22009;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("Foundation/CPMutableArray.j", NO);objj_executeFile("Foundation/CPString.j", NO);objj_executeFile("Foundation/CPKeyedUnarchiver.j", NO);var CPThemesByName = {},
...
{
    if (!aState || aState === objj_msgSend(CPNull, "null"))
        return this;
    var newStates = {};
...
CPThemeState = function()
{
    ...
    {
        if (arguments[argIndex] === objj_msgSend(CPNull, "null") || !arguments[argIndex])
            continue;
