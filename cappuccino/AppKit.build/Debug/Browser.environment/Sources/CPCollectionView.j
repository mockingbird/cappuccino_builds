@STATIC;1.0;I;20;Foundation/CPArray.jI;19;Foundation/CPData.jI;23;Foundation/CPIndexSet.jI;28;Foundation/CPKeyedArchiver.jI;30;Foundation/CPKeyedUnarchiver.ji;8;CPView.ji;22;CPCollectionViewItem.ji;17;CPCompatibility.jt;32286;
...
{ with(self)
{
    ...
    if (!_isSelectable)
    {
        var index = CPNotFound,
            itemCount = objj_msgSend(_items, "count");


        while ((index = objj_msgSend(_selectionIndexes, "indexGreaterThanIndex:", index)) != CPNotFound && index < itemCount)
...
{ with(self)
{
    ...
    if (!_isSelectable || objj_msgSend(_selectionIndexes, "isEqual:", anIndexSet))
        return;
...
{ with(self)
{
    ...
    while ((index = objj_msgSend(_selectionIndexes, "indexGreaterThanIndex:", index)) != CPNotFound && index < count)
        objj_msgSend(_items[index], "setSelected:", YES);
...
{ with(self)
{
    ...
    {
        if (_allowsMultipleSelection && (objj_msgSend(anEvent, "modifierFlags") & CPPlatformActionKeyMask || objj_msgSend(anEvent, "modifierFlags") & CPShiftKeyMask))
        {
...
{ with(self)
{
    ...
    var prototypeView = objj_msgSend(_itemPrototype, "view");
    if (prototypeView && (CGSizeEqualToSize(_minItemSize, CGSizeMakeZero()) || CGSizeEqualToSize(_maxItemSize, CGSizeMakeZero())))
    {
        ...
        if (CGSizeEqualToSize(_minItemSize, CGSizeMakeZero()))
            _minItemSize = objj_msgSend(prototypeView, "frameSize");
        else if (CGSizeEqualToSize(_maxItemSize, CGSizeMakeZero()))
            _maxItemSize = objj_msgSend(prototypeView, "frameSize");
    }
}
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _maxNumberOfRows = objj_msgSend(aCoder, "decodeIntForKey:", CPCollectionViewMaxNumberOfRowsKey);
        _maxNumberOfColumns = objj_msgSend(aCoder, "decodeIntForKey:", CPCollectionViewMaxNumberOfColumnsKey);
