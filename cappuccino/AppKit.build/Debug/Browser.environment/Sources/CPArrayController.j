@STATIC;1.0;I;23;Foundation/CPIndexSet.ji;20;CPObjectController.ji;19;CPKeyValueBinding.jt;35713;
...
{ with(self)
{
    return objj_msgSend(self, "__setSelectionIndexes:avoidEmpty:", indexes, _avoidsEmptySelection);
}
...
{ with(self)
{
    ...
    if (objj_msgSend(_selectionIndexes, "isEqualToIndexSet:", newIndexes))
        return NO;



    _selectionIndexes = indexes === newIndexes ? objj_msgSend(indexes, "copy") : newIndexes;
...
{ with(self)
{
    objj_msgSend(self, "__setSelectedObjects:avoidEmpty:", objects, _avoidsEmptySelection);
}
...
{ with(self)
{
    ...
    else if (_filterPredicate === nil || objj_msgSend(_filterPredicate, "evaluateWithObject:", object))
    {
...
{ with(self)
{
    ...
    if (_filterPredicate === nil || objj_msgSend(_filterPredicate, "evaluateWithObject:", object))
    {
        ...
        objj_msgSend(self, "__setSelectionIndexes:", _selectionIndexes);
    }
    ...
    objj_msgSend(anIndexSet, "enumerateIndexesWithOptions:usingBlock:", CPEnumerationReverse, function(anIndex)
        {
            ...
            if (objj_msgSend(_contentObject, "objectAtIndex:", anIndex) === object)
                objj_msgSend(_contentObject, "removeObjectAtIndex:", anIndex);
            else
            {
            ...
            if (!_avoidsEmptySelection || objj_msgSend(newSelectionIndexes, "count") > 1)
            {
