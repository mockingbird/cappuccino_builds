@STATIC;1.0;i;11;CPControl.ji;13;CPTextField.ji;10;CPButton.ji;8;CPView.ji;14;CPBezierPath.ji;20;_CPDatePickerClock.jI;23;Foundation/Foundation.jt;78254;objj_executeFile("CPControl.j", YES);objj_executeFile("CPTextField.j", YES);objj_executeFile("CPButton.j", YES);objj_executeFile("CPView.j", YES);objj_executeFile("CPBezierPath.j", YES);objj_executeFile("_CPDatePickerClock.j", YES);objj_executeFile("Foundation/Foundation.j", NO);var CPShortWeekDayNameArrayEn = ["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"],
...
,["void","BOOL"]), new objj_method(sel_getUid("layoutSubviews"), function $_CPDatePickerCalendar__layoutSubviews(self, _cmd)
{
    ...
    self.isa.objj_msgSend1(self, "setFrameSize:", ((___r1 = self._datePicker), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "frameSize")));
    var ___r1;
}
...
class_addMethods(the_class, [new objj_method(sel_getUid("initWithFrame:datePicker:delegate:"), function $_CPDatePickerHeaderView__initWithFrame_datePicker_delegate_(self, _cmd, aFrame, aDatePicker, aDelegate)
{
    ...
    if (self)
    {
        ...
        ((___r1 = self._previousButton), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setContinuous:", YES));
        ...
        ((___r1 = self._nextButton), ___r1 == null ? null : ___r1.isa.objj_msgSend1(___r1, "setContinuous:", YES));
...
,["void","CPDatePicker"]), new objj_method(sel_getUid("drawRect:"), function $_DatePickerBox__drawRect_(self, _cmd, aRect)
{
