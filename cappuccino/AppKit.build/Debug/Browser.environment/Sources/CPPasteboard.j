@STATIC;1.0;I;21;Foundation/CPObject.jI;20;Foundation/CPArray.jI;19;Foundation/CPData.jI;25;Foundation/CPDictionary.jI;40;Foundation/CPPropertyListSerialization.jt;13940;objj_executeFile("Foundation/CPObject.j", NO);objj_executeFile("Foundation/CPArray.j", NO);objj_executeFile("Foundation/CPData.j", NO);objj_executeFile("Foundation/CPDictionary.j", NO);objj_executeFile("Foundation/CPPropertyListSerialization.j", NO);CPGeneralPboard = "CPGeneralPboard";
...
,["void","DataTransfer"]), new objj_method(sel_getUid("_setPasteboard:"), function $_CPDOMDataTransferPasteboard___setPasteboard_(self, _cmd, aPasteboard)
{
    ...
    var types = (aPasteboard == null ? null : aPasteboard.isa.objj_msgSend0(aPasteboard, "types")),
        count = types.length;
    while (count--)
    {
        var type = types[count];
        if (type === CPStringPboardType)
            self._dataTransfer.setData(type, (aPasteboard == null ? null : aPasteboard.isa.objj_msgSend1(aPasteboard, "stringForType:", type)));
        else
            self._dataTransfer.setData(type, ((___r1 = (aPasteboard == null ? null : aPasteboard.isa.objj_msgSend1(aPasteboard, "dataForType:", type))), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "rawString")));
    }
    var ___r1;
}
...
,["CPArray"]), new objj_method(sel_getUid("dataForType:"), function $_CPDOMDataTransferPasteboard__dataForType_(self, _cmd, aType)
{
    ...
    if (aType === CPStringPboardType)
        return CPData.isa.objj_msgSend2(CPData, "dataFromPropertyList:format:", dataString, kCFPropertyList280NorthFormat_v1_0);
    return CPData.isa.objj_msgSend1(CPData, "dataWithRawString:", dataString);
}
,["CPData","CPString"]), new objj_method(sel_getUid("propertyListForType:"), function $_CPDOMDataTransferPasteboard__propertyListForType_(self, _cmd, aType)
{
    ...
    return CPPropertyListSerialization.isa.objj_msgSend2(CPPropertyListSerialization, "propertyListFromData:format:", self.isa.objj_msgSend1(self, "dataForType:", aType), CPPropertyListUnknownFormat);
}
,["id","CPString"])]);
class_addMethods(meta_class, [new objj_method(sel_getUid("DOMDataTransferPasteboard"), function $_CPDOMDataTransferPasteboard__DOMDataTransferPasteboard(self, _cmd)
{
    if (!DOMDataTransferPasteboard)
        DOMDataTransferPasteboard = ((___r1 = _CPDOMDataTransferPasteboard.isa.objj_msgSend0(_CPDOMDataTransferPasteboard, "alloc")), ___r1 == null ? null : ___r1.isa.objj_msgSend0(___r1, "init"));
