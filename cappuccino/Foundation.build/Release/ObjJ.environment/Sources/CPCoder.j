@STATIC;1.0;i;13;CPException.ji;10;CPObject.jt;2695;objj_executeFile("CPException.j", YES);objj_executeFile("CPObject.j", YES);{var the_class = objj_allocateClassPair(CPObject, "CPCoder"),
